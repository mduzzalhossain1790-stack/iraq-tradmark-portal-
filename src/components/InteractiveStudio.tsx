      ...
      <form onSubmit={handleSave} className="lg:col-span-8 bg-white border border-slate-200 rounded-xl shadow-sm p-4 md:p-6 text-left space-y-6">
        ...
        <div className="bg-gradient-to-r from-indigo-50 to-indigo-100/50 p-4 rounded-xl border border-indigo-200 space-y-3.5 shadow-sm">
          <div className="flex items-center space-x-1.5 text-xs text-indigo-950 font-black">
            ...
            <span>⚡ Simplified Trademark Registration</span>
          </div>
          <p className="text-[11px] text-indigo-900/80 leading-normal">
            Enter the <strong>Trademark Name</strong> and upload the <strong>Logo</strong>. The system will automatically generate all legal classifications, specifications, and register the certificate.
          </p>
          <div className="flex flex-col gap-2">
            <input 
              type="text"
              placeholder="Trademark Name (e.g. Al-Mansour Waters)"
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="text-xs text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100"
              />
            </div>
            <button
              type="button"
              ...
              disabled={aiLoading}
              className="w-full px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-bold text-xs shadow-sm cursor-pointer transition flex items-center justify-center space-x-1.5 disabled:opacity-50"
            >
              <Sparkles className="w-3.5 h-3.5" />
              <span>{aiLoading ? "Registering..." : "Create & Register Certificate"}</span>
            </button>
          </div>
        </div>

        {/* Hide other complex form fields for simplified view */}
        ...
        <div className="flex justify-between items-center bg-slate-50/80 -mx-4 md:-mx-6 -mb-4 md:-mb-6 p-4 rounded-b-xl border-t border-slate-200">
          ...
          >
            ...
            <span>{saveLoading ? "Saving..." : "Finalize Registration"}</span>
          </button>
        </div>
        </div>
        </form>
